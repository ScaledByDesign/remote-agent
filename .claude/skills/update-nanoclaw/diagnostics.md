...
curl -s -X POST https://us.i.posthog.com/capture/ \
  ...
  -d "{\"api_key\":\"REDACTED_POSTHOG_KEY\",\"event\":\"$(jq -r .event /tmp/nanoclaw-diagnostics.json)\",\"distinct_id\":\"$(uuidgen)\",\"properties\":$(jq .properties /tmp/nanoclaw-diagnostics.json)}"
