...
# Auto-generated by NanoClaw for workspace ${workspaceId}
TOKEN=$(curl -sf -m 5 \\
...
`;
  ...
  // (host: /opt/nanoclaw/groups/{folder}/workspace/, container: /workspace/group/workspace/)
  try {
    execSync(
